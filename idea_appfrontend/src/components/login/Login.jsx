...
function Login() {
    return (
        <MDBContainer fluid className='p-4 d-flex ' style={{ backgroundColor: "#f5f5f5", height:"100vh", alignItems: "center"}}>
            ...
            <MDBRow>
                ...
                <MDBCol md='7' className='text-center text-md-start d-flex flex-column justify-content-center'>
                    ...
                    <h1 className="my-5 display-3 fw-bold ls-tight px-3">
                        Share Ideas, <br />
                        <span className="text-primary">Spark Innovation, Connect People</span>
                    </h1>
